...
<body>
<!-- HEADER -->
<table class="template" border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0; width: 100%; background: #efefef; border-collapse: collapse; border-spacing: 0; color: #252525; font-family: 'Panton',Helvetica,sans-serif,Arial; font-size: 14px; font-weight: 400; line-height: 19px; ">
    <tr><td><center style="min-width: 580px; width: 100%;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; padding: 0; border-collapse: collapse; width: 580px;">
            ...
            <tr>
                ...
                <td style="margin: 0; padding: 0; padding-bottom: 15px; padding-right: 10px; width: 33.33%; vertical-align: top;">
                ...
                <td style="margin: 0; padding: 0; padding-bottom: 15px; padding-left: 20px; width: 33.33%; vertical-align: top;">
                    <p style="margin: 0; margin-bottom: 5px; padding: 0;"><a href="tel:+375333547887" style="color: #252525; font-size: 16px; font-weight: 400; line-height: 1.3;text-decoration: none;">+375 (33) 354-78-87</a></p>
                    <p style="margin: 0; margin-bottom: 5px; padding: 0;"><a href="tel:+375173027887" style="color: #252525; font-size: 16px; font-weight: 400; line-height: 1.3;text-decoration: none;">+375 (17) 302-78-87</a></p>
                </td>
        ...
        <p style="height:25px; margin: 0; padding: 0;">&#xA0;</p>
...
<table class="template" border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0; width: 100%; background: #efefef; border-collapse: collapse; border-spacing: 0; color: #252525; font-family: 'Panton',Helvetica,sans-serif,Arial; font-size: 14px; font-weight: 400; line-height: 19px; ">
    <tr><td><center style="min-width: 580px; width: 100%;">
        ...
        <table cellpadding="0" cellspacing="0" style="padding: 0; margin: 0 auto; background-color: #fff; border-left: 5px solid #ddd; border-right: 5px solid #ddd; border-collapse: collapse; border-spacing: 0; text-align: left; vertical-align: top; width: 580px;">
            <tbody>
            <tr>
...
<table class="template" border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0; width: 100%; background: #efefef; border-collapse: collapse; border-spacing: 0; color: #252525; font-family: 'Panton',Helvetica,sans-serif,Arial; font-size: 14px; font-weight: 400; line-height: 19px; ">
    ...
    <table cellpadding="0" cellspacing="0" style="padding: 0; margin: 0 auto; background-color: #fff; border-left: 5px solid #ddd; border-right: 5px solid #ddd; border-collapse: collapse; border-spacing: 0; text-align: left; vertical-align: top; width: 580px;">
        <tbody><tr><td style="margin: 0; padding: 0; padding-left: 15px; padding-right: 15px;  vertical-align: top; word-wrap: break-word;">

            <p style="height: 18px; margin: 0;">&#xA0;</p>

            <p style="color: #252525; font-size: 18px; font-weight: 400; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; ">С уважением, коллектив интернет-магазина <?php print ucfirst(PNEVMOTEH_DOMAIN); ?></p>

            <p>&#xA0;</p>

            <p style="color: #b7b7b7; font-size: 11px; font-weight: 400; line-height: 19px; margin: 0; margin-bottom: 10px; padding: 0; ">Если это письмо попало к Вам по ошибке, пожалуйста, сообщите об этом по адресу: <?php print variable_get('site_mail',''); ?>.</p>
